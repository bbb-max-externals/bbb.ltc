...
function(bbb_add_external)
	...
	# --- macOS bundle (.mxo) ---
	if(APPLE)
		string(TOLOWER "${EXTERNAL_NAME}" BBB_BUNDLE_IDENTIFIER_COMPONENT)
		string(REGEX REPLACE "[^a-z0-9.-]+" "-" BBB_BUNDLE_IDENTIFIER_COMPONENT "${BBB_BUNDLE_IDENTIFIER_COMPONENT}")
		string(REGEX REPLACE "^-+" "" BBB_BUNDLE_IDENTIFIER_COMPONENT "${BBB_BUNDLE_IDENTIFIER_COMPONENT}")
		string(REGEX REPLACE "-+$" "" BBB_BUNDLE_IDENTIFIER_COMPONENT "${BBB_BUNDLE_IDENTIFIER_COMPONENT}")
		set(AUTHOR_DOMAIN "jp.2bit")
		set(BUNDLE_IDENTIFIER "${BBB_BUNDLE_IDENTIFIER_COMPONENT}")
		set(BBB_INFO_PLIST "${CMAKE_CURRENT_BINARY_DIR}/${EXTERNAL_NAME}-Info.plist")
		configure_file(
			"${C74_MAX_SDK_DIR}/script/Info.plist.in"
			"${BBB_INFO_PLIST}"
			@ONLY
		)
		...
		set_target_properties(${EXTERNAL_NAME} PROPERTIES
			...
			MACOSX_BUNDLE_INFO_PLIST "${BBB_INFO_PLIST}"
			MACOSX_BUNDLE_GUI_IDENTIFIER "jp.2bit.${BBB_BUNDLE_IDENTIFIER_COMPONENT}"
			XCODE_ATTRIBUTE_PRODUCT_BUNDLE_IDENTIFIER "jp.2bit.${BBB_BUNDLE_IDENTIFIER_COMPONENT}"
		)
